...
class AAF_Test10(unittest.TestCase):
    ...
    def test_method(self):
        ...
        time.sleep(3.0)
        view_mentor_button = driver.find_element_by_xpath('/html/body/div/div/div/div[2]/div[1]/div[2]/a').click()
        edit_button = driver.find_element_by_xpath('/html/body/div/div[2]/table/tbody/tr[4]/td[5]/a').click()

        middle_name = driver.find_element_by_id('id_name').send_keys("Test")
        ...
        try:
            ...
            self.fail("editing mentor failed")
            assert False
