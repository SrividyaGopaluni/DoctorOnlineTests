...
class AAF_Test12(unittest.TestCase):
    ...
    def test_method(self):
        ...
        elem = driver.find_element_by_xpath('/html/body/div/div/div/div[2]/div[1]/div[2]/a').click()

        try:
            # attempt to find the plus button - if found, logged in
            elem = driver.find_element_by_xpath('/html/body/div/div[2]/table/thead/tr/th[1]')
            assert True
