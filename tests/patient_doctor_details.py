...
class AAF_Test6(unittest.TestCase):
    ...
    def test_method(self):
        ...
        elem = driver.find_element_by_xpath('/html/body/div/div/div/div/div[1]/a').click()

        try:
            # attempt to find the plus button - if found, logged in
            elem = driver.find_element_by_xpath('/html/body/div/div[3]/table/thead/tr/th[1]')
            assert True
        except NoSuchElementException:
            self.fail("Doctor details Failed")
            assert False
