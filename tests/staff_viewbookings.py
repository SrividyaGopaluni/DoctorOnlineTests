...
class AAF_Test14(unittest.TestCase):
    ...
    def test_method(self):
        ...
        elem = driver.find_element_by_xpath('/html/body/div/div/div/div[1]/button/a/b').click()

        try:
            # attempt to find the plus button - if found, logged in
            elem = driver.find_element_by_xpath('/html/body/div/div[2]/h2')
            assert True
        except NoSuchElementException:
            self.fail("view details Failed")
            assert False
